...
export default function SignupPage() {
    ...
    // Initialize Google Login on mount
    useEffect(() => {
                ...
                google.accounts.id.initialize({
                    ...
                    callback: async (response: any) => {
                        ...
                        try {
                            ...
                            // Google users skip OTP, go straight to MetaMask
        ...
        >
            <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-4">
                ...
                <motion.div variants={fadeUp}>
                    <div className="relative group overflow-hidden rounded-xl border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-300">
                        <div className="absolute inset-0 flex items-center justify-center gap-2 pointer-events-none">
                            ...
                            <span className="text-sm text-zinc-300 group-hover:text-white transition-colors">Google</span>
                        </div>
                        <div
                            id="google-signup-btn"
                            className="opacity-0 w-full h-11"
